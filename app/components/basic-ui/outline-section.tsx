    ...
    return (
        <div className="w-full h-full p-24">
            <Section className="text-center max-w-2xl mx-auto">
                <div className="flex flex-col mt-24 items-center max-w-2xl mx-auto p-8 bg-white rounded-2xl shadow-sm">
                    <Image 
                        className="rounded-full border-4 border-sky-100 w-32 h-32 object-cover mb-6"
                        width={200}
                        height={200} 
                        alt="Lab Avatar"
                        src="/avatar.jpg"
                    ...
                    <div className="text-center w-full"> 
                        <h1 className="text-3xl font-bold text-gray-900">IIC</h1>
                    ...
                    <div className="w-full text-left space-y-5 mt-6"> 
                        ...
                        <span className="block font-semibold text-gray-700 mb-2">Research Achievements:</span>
